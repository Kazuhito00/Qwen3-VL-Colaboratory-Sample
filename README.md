...
# License 
Qwen3-VL-Colaboratory-Sample is under [Apache2.0 license](LICENSE).

# License(Image)
サンプル実行用に格納している画像は、[ぱくたそ](https://www.pakutaso.com)様の[京都駅JR線のりば（西口）の](https://www.pakutaso.com/20200832239jr-57.html)を利用しています。
